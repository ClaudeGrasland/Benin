...
```{r}
dep<-read.table("data/langues/bj_lang_adm1_correct.csv", sep=";",header =TRUE, dec=",")
dep<-dep[,c(1:2,77:82)]
kable(dep)
```
...
map <- st_read("data/admin/ben_admbnda_adm1_1m_salb_20190816.shp", quiet=TRUE)  %>% select(admin1Pcod)     

# Jointure
mapdep<-merge(map,dep,by.x="admin1Pcod",by.y="admin1_code")
...
ggplot(data = dep) + aes(x=100*literacy_male, y = 100*literacy_female, label = admin1_name) +
                     geom_point(col="red") + 
...
<tr><td style="text-align:left"></td><td>literacy_female</td></tr>
<tr><td colspan="2" style="border-bottom: 1px solid black"></td></tr><tr><td style="text-align:left">literacy_male</td><td>0.793<sup>***</sup></td></tr>
<tr><td style="text-align:left"></td><td>(0.068)</td></tr>
<tr><td style="text-align:left"></td><td></td></tr>
<tr><td style="text-align:left">Constant</td><td>-0.047</td></tr>
<tr><td style="text-align:left"></td><td>(0.043)</td></tr>
<tr><td style="text-align:left"></td><td></td></tr>
<tr><td colspan="2" style="border-bottom: 1px solid black"></td></tr><tr><td style="text-align:left">Observations</td><td>12</td></tr>
<tr><td style="text-align:left">R<sup>2</sup></td><td>0.932</td></tr>
<tr><td style="text-align:left">Adjusted R<sup>2</sup></td><td>0.925</td></tr>
<tr><td style="text-align:left">Residual Std. Error</td><td>0.038 (df = 10)</td></tr>
<tr><td style="text-align:left">F Statistic</td><td>136.646<sup>***</sup> (df = 1; 10)</td></tr>
